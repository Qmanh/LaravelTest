    ...
    <div class="container">
        <div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
            <div class="col-lg-4 logo">
                <a href="{{ route('showPost') }}" class="text-decoration-none">
                    <span class="h1 text-uppercase text-primary bg-dark px-2">POSTS</span>
            ...
            <div class="col-lg-6 col-6 text-left  d-flex justify-content-end align-items-center">
                ...
                @endif
                    <a href="{{route('homePage')}}" class="nav-link text-dark">Products</a>
                <form action="{{route('showPost')}}" method="get">
    ...
    <div class="container">
        <nav class="navbar navbar-expand-xl" id="navbar">
            <a href="#" class="text-decoration-none mobile-logo">
                <span class="h2 text-uppercase text-primary bg-dark">POST</span>
                <span class="h2 text-uppercase text-white px-2">LIST</span>
            </a>
